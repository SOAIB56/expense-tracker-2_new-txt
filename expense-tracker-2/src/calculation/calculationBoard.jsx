              ...
              <div className="mx-auto max-w-7xl">
                <dl className="grid grid-cols-1 text-center lg:grid-cols-3 divide-x-2 border rounded-md overflow-hidden">
                  ...
                  <div className="bg-[#F9FAFB] flex lg:max-w-xs flex-col px-4 py-4">
                    ...
                    <dd className="order-first text-xl font-semibold tracking-tight text-green-500 sm:text-3xl">
                      BDT {income}
                    </dd>
                  </div>
                  <div className="bg-[#F9FAFB] flex lg:max-w-xs flex-col px-4 py-4">
                    ...
                    <dd className="order-first text-xl font-semibold tracking-tight text-red-600 sm:text-3xl">
                      BDT {expense}
                    </dd>
                  </div>
                </dl>
