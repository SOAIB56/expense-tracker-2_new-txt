...
export default function Income({
  ...
  const incomeItems = filterOperationIncomeList.map((transaction) => (
    ...
    >
      <div>
        <h3 className="text-base font-medium leading-7 text-amber-700">
      ...
      <div className="flex items-center gap-2">
        <p className="text-base font-semibold text-green-400 transition-all group-hover:-translate-x-14">
